...
export class Serialization {
   ...
   */
  static toYAML(obj: unknown): string {
    const plain = instanceToPlain(obj);
   ...
   */
  static fromJSON<T>(cls: new (...args: unknown[]) => T, jsonString: string): T {
   ...
   */
  static fromYAML<T>(cls: new (...args: unknown[]) => T, yamlString: string): T {
