 ...
 */
export class KnowledgeGraphProviderDefinition extends Hydrator<KnowledgeGraphProviderDefinition> {
  constructor(model?: Partial<KnowledgeGraphProviderDefinition>) {
    super(model);
    if (model) {
