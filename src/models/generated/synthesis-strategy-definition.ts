...
export class SynthesisStrategyDefinition extends KernelFunctionStrategyDefinition {
  constructor(model?: Partial<SynthesisStrategyDefinition>) {
    super(model);
  }

  /**
   * The variable name used to pass the collection of inputs to the synthesis function
   */
  inputsVariableName: string;
}
