 ...
 */
export class AgentInterfaceDefinition extends AgentDefinition {
  constructor(model?: Partial<AgentInterfaceDefinition>) {
    super(model);
    if (model) {
  ...
  /**
   * The access points through which the agent interface is made available
   */
