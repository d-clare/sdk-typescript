...
export class InterfaceEndpointCollectionDefinition extends Hydrator<InterfaceEndpointCollectionDefinition> {
  ...
  /**
   * A boolean indicating whether or not the interface is publicly documented and accessible via the A2A protocol
   */
  @Expose({ name: 'a2a' })
  a2A: boolean;

  /**
   * The HTTP-specific configuration used to expose the interface over standard web protocols
   */
