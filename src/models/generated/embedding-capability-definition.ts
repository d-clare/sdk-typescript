...
export class EmbeddingCapabilityDefinition extends Hydrator<EmbeddingCapabilityDefinition> {
  ...
  /**
   * The identifier of the model provider to use for embeddings.
   */
  provider: string;

  /**
   * The model name to be used for the embedding operation.
   */
  model: string;

  /**
   * The definition of the embedding API to use
   */
