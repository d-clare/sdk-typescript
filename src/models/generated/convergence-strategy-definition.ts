...
export class ConvergenceStrategyDefinition extends Hydrator<ConvergenceStrategyDefinition> {
  ...
  /**
   * The kernel function strategy, if any, used to decompose the initial prompt into specialized sub-prompts tailored to each contributing agent
   */
  @Type(() => DecompositionStrategyDefinition)
  decomposition?: DecompositionStrategyDefinition;

  /**
   * The kernel function strategy used to synthesize the individual agent responses into a single, unified output
   */
