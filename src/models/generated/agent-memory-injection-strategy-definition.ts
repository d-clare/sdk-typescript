...
export class AgentMemoryInjectionStrategyDefinition extends Hydrator<AgentMemoryInjectionStrategyDefinition> {
  ...
  /**
   * The definition of the search and filtering strategy, if any, to match relevant memory entries
   */
  @Type(() => AgentMemorySearchDefinition)
  match?: AgentMemorySearchDefinition;

  /**
   * An object, if any, that defines how the matched memory entries should be formatted and injected
   */
