 ...
 */
export class CallTaskDefinition extends TaskDefinition {
  constructor(model?: Partial<CallTaskDefinition>) {
    super(model);
    if (model) {
      if (model.call) this.call = model.call;
      this.with = model.with ? model.with : {};
    }
  }
   ...
   */
  call: FunctionDefinition | string;
