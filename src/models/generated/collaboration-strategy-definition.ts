...
export class CollaborationStrategyDefinition extends Hydrator<CollaborationStrategyDefinition> {
  ...
  /**
   * The kernel function strategy used to select which agents participate and in what order or combination
   */
  @Type(() => SelectionStrategyDefinition)
  selection: SelectionStrategyDefinition;

  /**
   * The kernel function strategy used to determine when the collaborative process should conclude
   */
