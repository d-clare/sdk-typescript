...
export class KernelDefinition extends ReferenceableComponentDefinition {
  ...
  /**
   * A reference to the kernel definition to extend, if any
   */
  extends?: string;

  /**
   * The configuration of the kernel's reasoning capability, if any
   */
  @Type(() => ReasoningCapabilityDefinition)
  reasoning?: ReasoningCapabilityDefinition;

  /**
   * The configuration of the kernel's embedding capability, if any
   */
  @Type(() => EmbeddingCapabilityDefinition)
  embedding?: EmbeddingCapabilityDefinition;

  /**
   * A key/definition mapping of the toolsets available to the kernel
   */
