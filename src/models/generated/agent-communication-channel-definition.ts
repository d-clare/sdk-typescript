...
import { A2ACommunicationChannelDefinition } from './a2a-communication-channel-definition';
...
export class AgentCommunicationChannelDefinition extends Hydrator<AgentCommunicationChannelDefinition> {
  constructor(model?: Partial<AgentCommunicationChannelDefinition>) {
    super(model);
    if (model) {
      if (model.a2A) this.a2A = new A2ACommunicationChannelDefinition(model.a2A);
    }
   ...
   */
  @Expose({ name: 'a2a' })
  @Type(() => A2ACommunicationChannelDefinition)
  a2A?: A2ACommunicationChannelDefinition;
