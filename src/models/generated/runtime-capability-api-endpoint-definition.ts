 ...
 */
export class RuntimeCapabilityApiEndpointDefinition extends Hydrator<RuntimeCapabilityApiEndpointDefinition> {
  constructor(model?: Partial<RuntimeCapabilityApiEndpointDefinition>) {
    super(model);
    if (model) {
