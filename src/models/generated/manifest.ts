...
export class Manifest extends Hydrator<Manifest> {
  ...
  /**
   * An object used to describe the manifest
   */
  @Type(() => ManifestMetadata)
  metadata: ManifestMetadata;

  /**
   * A collection of reusable components, if any, that can be referenced throughout the manifest
   */
  @Type(() => ComponentCollectionDefinition)
  components?: ComponentCollectionDefinition;

  /**
   * A collection of interfaces through which the application's components are made accessible
   */
