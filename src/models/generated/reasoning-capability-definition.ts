...
export class ReasoningCapabilityDefinition extends Hydrator<ReasoningCapabilityDefinition> {
  ...
  /**
   * The identifier of the model provider to use for reasoning
   */
  provider: string;

  /**
   * The model name to be used for the reasoning operation
   */
  model: string;

  /**
   * The definition of the reasoning API to use
   */
  @Type(() => RuntimeCapabilityApiDefinition)
  api: RuntimeCapabilityApiDefinition;

  /**
   * The optional provider-specific parameters used when invoking the model, such as temperature, top_p, max_tokens, stop, etc.
   */
