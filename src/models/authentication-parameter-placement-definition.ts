 ...
 */
export class AuthenticationParameterPlacementDefinition extends Hydrator<AuthenticationParameterPlacementDefinition> {

  constructor(model?: Partial<AuthenticationParameterPlacementDefinition>) {
    super(model);
  }
